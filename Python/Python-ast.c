...
*BitAnd_singleton, *FloorDiv_singleton, *LAssign_singleton, *RAssign_singleton;
...
static PyTypeObject *RAssign_type;
static PyTypeObject *unaryop_type;
...
static int init_types(void)
{
    ...
    RAssign_type = make_type("RAssign", operator_type, NULL, 0);
    if (!RAssign_type) return 0;
    RAssign_singleton = PyType_GenericNew(RAssign_type, NULL, NULL);
    if (!RAssign_singleton) return 0;
...
PyObject* ast2obj_operator(operator_ty o)
{
    switch(o) {
        ...
        case RAssign:
            Py_INCREF(RAssign_singleton);
            return RAssign_singleton;
        default:
            /* should never happen, but just in case ... */
...
obj2ast_operator(PyObject* obj, operator_ty* out, PyArena* arena)
{
    ...
    isinstance = PyObject_IsInstance(obj, (PyObject *)LAssign_type);
    if (isinstance == -1) {
        return 1;
    }
    if (isinstance) {
    ...
    isinstance = PyObject_IsInstance(obj, (PyObject *)RAssign_type);
    if (isinstance == -1) {
        return 1;
    }
    if (isinstance) {
...
PyInit__ast(void)
{
    ...
    if (PyDict_SetItemString(d, "FloorDiv", (PyObject*)FloorDiv_type) < 0)
        return NULL;
    if (PyDict_SetItemString(d, "LAssign", (PyObject*)LAssign_type) < 0) return
        NULL;
    if (PyDict_SetItemString(d, "RAssign", (PyObject*)RAssign_type) < 0) return
        NULL;
    if (PyDict_SetItemString(d, "unaryop", (PyObject*)unaryop_type) < 0) return
        NULL;
